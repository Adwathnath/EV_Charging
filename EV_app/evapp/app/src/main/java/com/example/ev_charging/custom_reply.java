...
public class custom_reply extends BaseAdapter{
    ...
    public custom_reply(Context applicationContext, ArrayList<String> t1, ArrayList<String> t2, ArrayList<String> t3,ArrayList<String> t4) {
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        if (t4.get(position).equalsIgnoreCase("pending")){
            tx4.setTextColor(Color.BLUE);
        }
        else{
            tx4.setTextColor(Color.MAGENTA);
        }
