...
//        EditText etApiKey = findViewById(R.id.et_api_key);
        String keyy = "rzp_test_kWmC6xxURL9LfD";
        ...
        if (!TextUtils.isEmpty(etCustomOptions.getText().toString())){
            ...
            try {
                ...
                options.put("amount", Integer.parseInt(sh.getString("amt",""))*100);

                JSONObject preFill = new JSONObject();
                preFill.put("email", "test@razorpay.com");
                preFill.put("contact", "7902847782");
    ...
    public void onPaymentSuccess(String s, PaymentData paymentData) {
        try{
            ...
            String url = "http://" + ip + ":5000/android/payment";
...
//                                edp.commit();
                ...
                protected Map<String, String> getParams() {
                    ...
                    params.put("slot",sh.getString("sid",""));
                    params.put("date",sh.getString("date",""));
                    params.put("time",sh.getString("time",""));
