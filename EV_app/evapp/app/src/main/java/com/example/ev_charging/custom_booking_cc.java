...
public class custom_booking_cc extends BaseAdapter{
    private Context context;
    ArrayList<String> t1,t2,t3,t4;
    SharedPreferences sh;
    public custom_booking_cc(Context applicationContext, ArrayList<String> t1, ArrayList<String> t2, ArrayList<String> t3, ArrayList<String> t4) {
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        if(convertview==null)
        {
            ...
            gridView=inflator.inflate(R.layout.activity_custom_booking_cc, null);
